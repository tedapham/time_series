...
ts.plot(emp.test,lm_fcst$mean, 
        gpars=list(main="Unemployment Rate: Actual versus Forecast to 2020",xlab="year", ylab="Unemployment Rate (%)"), 
        col = c("black", "red"), lwd = 2, lty = 1:2)
...
ts.plot(emp.test,lm_fcst$mean, exp(forecast2$mean),
        gpars=list(main="Comparison between SARIMA and Linear Regression Forecast",xlab="year", ylab="Unemployment Rate (%)"), 
...
legend("bottomleft", lty = c(1,1), legend = c("Actual auto sale (2016 - 2017)","VAR forecast"), col = c('black',"green"))
```
...
legend("bottomleft", lty = c(1,1), legend = c("Actual unemployment rate (2016 - 2017)","VAR forecast"), col = c('black',"blue"))
```
...
legend("bottomleft", lty = c(1,3,3), legend = c("Actual Rate","VAR forecast","SARIMA Forecast"), col = c('black',"blue","red"))
```
